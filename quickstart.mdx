...
<AccordionGroup>
  <Accordion icon="github" title="Deploy your changes">
    Set up automatic deployments through your hosting provider or use GitHub Actions to deploy your documentation automatically when you push changes to your repository.
    
    Your documentation will be deployed automatically whenever you make changes to your repository.
</Accordion>
...
<Note>
  **Need help?** Contact support@keymint.dev for assistance with your documentation.
</Note>
